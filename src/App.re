 ...
 */
 module App = {
  ...
  let make = () => {
    ...
    /*
     * The `Create_melange_app.Configuration.make` function is a for creating 
     ...
     * placeholders inside the curly braces (e.g., `my_super_cool_app`) will be replaced 
    ...
    let configuration =
      Create_melange_app.Configuration.make(
        ~name="my_super_cool_app",
        ~directory="/Users/dillon/Code/cma-testing/my_super_cool_app",
